        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5"  style="margin-bottom:5px;">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6"><img style="width:500px; height:470px;"class="card-img-top mb-5 mb-md-0" src="FlujoFarmacia/Imagen/asd.jpg" alt="...">
                    ...
                    <div class="col-md-6">
						...
						<input class="form-control text-left me-3" id="inputQuantity" type="" style="max-width: 15rem">
						  ...
						  <div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								¿Estas seguro de que quiere Añadir el producto?
							  </div>
							  <div class="modal-footer">
								<button style="margin-right:10px" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
								<button class="btn btn-success" onclick="alert('Se ha añadido el producto')" data-bs-dismiss="modal">Aceptar</button>
							  </div>
							</div>
						  </div>
						</div>
						<div class="column"><a style="margin-left:0px;" class="btn btn-success" data-bs-toggle="modal" href="#exampleModalToggle">Agregar Producto</a></div>
					</div>
                </div>
